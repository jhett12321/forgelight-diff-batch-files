...
set gameDir=F:\Program Files (x86)\Steam\SteamApps\common\PlanetSide 2 Test
set gameDataDir=C:\Users\Jhett\My Projects\SOE Version Tracker\Repos\Planetside 2 Test\gamedata
set toolDataDir=C:\Users\Jhett\My Projects\SOE Version Tracker\Repos\Planetside 2 Test\tooldata
